      ...
      >
        ...
        >
          ...
          <button
            ...
            class="relative flex size-12 cursor-pointer items-center justify-center rounded-full bg-white text-black outline-none transition-transform active:scale-95 focus-visible:ring-2 focus-visible:ring-theme-500 focus-visible:ring-offset-2"
            @click="toggleMenu"
          >
            <motion.span
              aria-hidden="true"
